...
class RateLimitingBannerTest < Minitest::Test
  ...
  BANNER_HEADING = "From September 2026, rate limiting will apply to the Trade Tariff API to protect service reliability.".freeze
  BANNER_BODY = "Access a higher rate limit through the Trade Tariff developer portal.".freeze
  BANNER_LINK_TEXT = "Find out more about the Developer Portal".freeze
